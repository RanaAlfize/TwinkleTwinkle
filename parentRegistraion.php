...
<section class="registerCards">
    <div class="contentManal">
        <div class="cardRManal"  id="cardP">
            <div class="iconManal">
                <img src="img/mother.png" alt="machine icon">
            </div>
            ...
            $final_file=str_replace(' ','-',$new_file_name);
                ...
                $sql = "INSERT INTO users ". "(password, first_name,last_name,email,city ,photo,role,location
               ) ". "VALUES('$password','$first_name','$last_name','$email','$city','$final_file','1','$location' )";
            ...
            <form class="registrationForm2" method = "post"  action = "<?php $_PHP_SELF ?>" name="myform" id="myform" onsubmit="return validateform()" enctype="multipart/form-data">
                ...
                <button type="submit" value="submit" class="form-btnManal"  id="form-btnSub" name = "add"> submit</button>
                <button type="reset" value="reset" class="form-btnManal" id="form-btnRes"> reset</button>
